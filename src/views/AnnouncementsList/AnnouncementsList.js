...
const useStyles = makeStyles((theme) => ({
  ...
  heroContent: {
    backgroundImage: 'url(https://www.pixelstalk.net/wp-content/uploads/2015/01/Snow-winter-landscape-wallpaper-widescreen.jpg)',
    ...
    <React.Fragment>
      ...
      <main className={classes.main}>
        ...
        <div className={classes.heroContent}>
          <Container maxWidth="sm">
            ...
            <Typography variant="h5" align="center" color="textSecondary" paragraph>
              <b>Vous avez quelques choses qui vou n'avez plus besoins,vous ne voulez pas le jeté en dehors?<br/>
              vos gadgets inutiles sont utiles pour quelqun d'autre ,Faites les un don ici en quelques clics !</b>
            </Typography>
            <div className={classes.heroButtons}>
              <Grid container spacing={2} justify="center">
                ...
                <Grid item>
                  <Button variant="outlined" color="primary" onClick={()=>history.push('contactus')}>
                    Contacter nous
                  </Button>
                </Grid>
              </Grid>
        ...
        <Container className={classes.cardGrid} maxWidth="md">
          ...
          <div className="img-container">
          <h1>Oops!</h1>
          <img height="280" width="300" src="https://rivasdev.tech/assets/img/no-data-found.png"/>
